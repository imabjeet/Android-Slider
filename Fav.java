...
public class Fav extends Activity {
    ...
    public static final long serialVersionUID = -5962258654856381755L;

    /* renamed from: com.example.restro.Fav$1 */
    public class C00041 implements OnItemClickListener {
        public static volatile transient /* synthetic */ IncrementalChange $change = null;
        public static final long serialVersionUID = -1938029405014994669L;
        public final /* synthetic */ Fav this$0;

        C00041(Object[] objArr, InstantReloadException instantReloadException) {
            String str = objArr[1];
            int hashCode = str.hashCode();
            if (hashCode == -1968665286) {
                return;
            }
            if (hashCode == -1786779069) {
                this(objArr[2]);
            } else {
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/restro/Fav$1"}));
            }
        }

        public static /* synthetic */ Object access$super(C00041 r3, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
        ...
        public C00041(Fav this$02) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$02;
            if (incrementalChange != null) {
                Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/restro/Fav$1;Lcom/example/restro/Fav;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$02, new Object[0]});
                Object[] objArr2 = (Object[]) objArr[0];
                this(objArr, null);
                objArr2[0] = this;
                incrementalChange.access$dispatch("init$body.(Lcom/example/restro/Fav$1;Lcom/example/restro/Fav;[Ljava/lang/Object;)V", objArr2);
            }
        }
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            i.putExtra("type", "AND Fav=1");
            this.this$0.startActivity(i);
        }
    }

    Fav(Object[] objArr, InstantReloadException instantReloadException) {
        String str = objArr[1];
        int hashCode = str.hashCode();
        if (hashCode == -1408191849) {
            this();
        } else if (hashCode != -1230767868) {
            throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/restro/Fav"}));
        }
    }

    public static /* synthetic */ Object access$super(Fav fav, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2147180915:
    ...
    public Fav() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/restro/Fav;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, new Object[0]});
            Object[] objArr2 = (Object[]) objArr[0];
            this(objArr, null);
            objArr2[0] = this;
            incrementalChange.access$dispatch("init$body.(Lcom/example/restro/Fav;[Ljava/lang/Object;)V", objArr2);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        List<String> array = dbHelper.Get_ContactDetails("SELECT * FROM Table2 WHERE Fav=1");
        dbHelper.close();
        ((TextView) findViewById(C0005R.C0006id.f0AC)).setText("Favourites");
        ...
        lv.setOnItemClickListener(new C00041(this));
    }
}
