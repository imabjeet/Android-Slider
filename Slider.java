...
public class Slider extends Activity {
    ...
    public static final long serialVersionUID = -7003730808466135249L;
    ...
    /* renamed from: com.example.restro.Slider$1 */
    public class C00071 implements OnPageChangeListener {
        public static volatile transient /* synthetic */ IncrementalChange $change = null;
        public static final long serialVersionUID = -668572965979722269L;
        public final /* synthetic */ Slider this$0;

        C00071(Object[] objArr, InstantReloadException instantReloadException) {
            String str = objArr[1];
            int hashCode = str.hashCode();
            if (hashCode == -1968665286) {
                return;
            }
            if (hashCode == -1232283179) {
                this(objArr[2]);
            } else {
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/restro/Slider$1"}));
            }
        }

        public static /* synthetic */ Object access$super(C00071 r3, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
        ...
        public C00071(Slider this$02) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$02;
            if (incrementalChange != null) {
                Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/restro/Slider$1;Lcom/example/restro/Slider;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$02, new Object[0]});
                Object[] objArr2 = (Object[]) objArr[0];
                this(objArr, null);
                objArr2[0] = this;
                incrementalChange.access$dispatch("init$body.(Lcom/example/restro/Slider$1;Lcom/example/restro/Slider;[Ljava/lang/Object;)V", objArr2);
            }
        }
        ...
        public void onPageScrolled(int i, float v, int i1) {
            IncrementalChange incrementalChange = $change;
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("onPageScrolled.(IFI)V", new Object[]{this, new Integer(i), new Float(v), new Integer(i1)});
                return;
            }
            Slider.access$002(i);
            if (((Integer) Slider.access$100(this.this$0).get(Slider.access$000())).intValue() == 1) {
                this.this$0.fav.setBackgroundResource(C0005R.drawable.fav_star);
            } else {
                this.this$0.fav.setBackgroundResource(C0005R.drawable.fav);
            }
        }
        ...
        public void onPageSelected(int i) {
            IncrementalChange incrementalChange = $change;
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("onPageSelected.(I)V", new Object[]{this, new Integer(i)});
            }
        }
        ...
        public void onPageScrollStateChanged(int i) {
            ...
            int i2 = 0;
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("onPageScrollStateChanged.(I)V", new Object[]{this, new Integer(i)});
                return;
            }
            Log.e("State::", Integer.toString(i));
            int currentPage = Slider.pager.getCurrentItem();
            if (currentPage == Slider.access$100(this.this$0).size() - 1 || currentPage == 0) {
                Slider.access$202(Slider.access$300());
                Slider.access$302(i);
                if (Slider.access$200() == 1 && Slider.access$300() == 0) {
                    ViewPager viewPager = Slider.pager;
                    if (currentPage == 0) {
                        i2 = Slider.access$100(this.this$0).size() - 1;
                    }
    ...
    Slider(Object[] objArr, InstantReloadException instantReloadException) {
        String str = objArr[1];
        int hashCode = str.hashCode();
        if (hashCode == -1230767868) {
            return;
        }
        if (hashCode == 2146839635) {
            this();
        } else {
            throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/restro/Slider"}));
        }
    }

    public static /* synthetic */ Object access$super(Slider slider, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2147180915:
            ...
            case -1076054347:
                ...
                return null;
            case -1053855858:
                super.onActionModeStarted((ActionMode) objArr[0]);
                return null;
            case -1025252350:
            ...
            case -212501619:
                super.onActionModeFinished((ActionMode) objArr[0]);
                return null;
            case -201279008:
    ...
    public Slider() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/restro/Slider;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, new Object[0]});
            Object[] objArr2 = (Object[]) objArr[0];
            this(objArr, null);
            objArr2[0] = this;
            incrementalChange.access$dispatch("init$body.(Lcom/example/restro/Slider;[Ljava/lang/Object;)V", objArr2);
            return;
        }
        this.imageArray = new ArrayList<>();
        this.name = new ArrayList<>();
        this.detail = new ArrayList<>();
        this.pageChangeListener = new C00071(this);
    }
    ...
    public static /* synthetic */ int access$000() {
        ...
        return ((Number) incrementalChange.access$dispatch("access$000.()I", new Object[0])).intValue();
    }

    public static /* synthetic */ int access$002(int x0) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            return ((Number) incrementalChange.access$dispatch("access$002.(I)I", new Object[]{new Integer(x0)})).intValue();
        }
        currentPage = x0;
        return x0;
    }

    public static /* synthetic */ ArrayList access$100(Slider x0) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange == null) {
            return x0.favArray;
        }
        return (ArrayList) incrementalChange.access$dispatch("access$100.(Lcom/example/restro/Slider;)Ljava/util/ArrayList;", new Object[]{x0});
    }
    ...
    public static /* synthetic */ int access$200() {
        ...
        return ((Number) incrementalChange.access$dispatch("access$200.()I", new Object[0])).intValue();
    }

    public static /* synthetic */ int access$202(int x0) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            return ((Number) incrementalChange.access$dispatch("access$202.(I)I", new Object[]{new Integer(x0)})).intValue();
        }
        previousState = x0;
        return x0;
    }
    ...
    public static /* synthetic */ int access$300() {
        ...
        return ((Number) incrementalChange.access$dispatch("access$300.()I", new Object[0])).intValue();
    }

    public static /* synthetic */ int access$302(int x0) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            return ((Number) incrementalChange.access$dispatch("access$302.(I)I", new Object[]{new Integer(x0)})).intValue();
        }
        currentState = x0;
        return x0;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0005R.layout.activity_detail);
        this.fav = (ImageButton) findViewById(C0005R.C0006id.fav);
        Intent i = getIntent();
        ...
        this.imageArray = this.dbHelper.getImage(str, query);
        this.name = this.dbHelper.getName(str, query);
        this.detail = this.dbHelper.getDetail(str, query);
        this.favArray = this.dbHelper.getFav(str, query);
        this.dbHelper.close();
        init();
    }
    ...
    private void init() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("init.()V", new Object[]{this});
            return;
        }
        pager = findViewById(C0005R.C0006id.pager);
        pager.setAdapter(new ImageAdapter(this, this.imageArray, this.name, this.detail));
        pager.setOnPageChangeListener(this.pageChangeListener);
    }

    public void selectFav(View view) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("selectFav.(Landroid/view/View;)V", new Object[]{this, view});
            return;
        }
        String str = "'";
        if (((Integer) this.favArray.get(currentPage)).intValue() == 1) {
            this.fav.setBackgroundResource(C0005R.drawable.fav);
            this.dbHelper = new DBHelper(this);
            StringBuilder sb = new StringBuilder();
            sb.append("UPDATE Table2 SET Fav=0 WHERE Name='");
            sb.append((String) this.name.get(currentPage));
            sb.append(str);
            this.dbHelper.update(sb.toString());
            this.dbHelper.close();
            this.favArray.set(currentPage, Integer.valueOf(0));
        } else {
            this.fav.setBackgroundResource(C0005R.drawable.fav_star);
            this.dbHelper = new DBHelper(this);
            StringBuilder sb2 = new StringBuilder();
            sb2.append("UPDATE Table2 SET Fav=1 WHERE Name='");
            sb2.append((String) this.name.get(currentPage));
            sb2.append(str);
            this.dbHelper.update(sb2.toString());
            this.dbHelper.close();
            this.favArray.set(currentPage, Integer.valueOf(1));
        }
    }
    ...
    public void next(View view) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("next.(Landroid/view/View;)V", new Object[]{this, view});
            return;
        }
        currentPage++;
        if (currentPage == this.imageArray.size()) {
            currentPage = 0;
        }
        Log.e("next", Integer.toString(currentPage));
    ...
    public void back(View view) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("back.(Landroid/view/View;)V", new Object[]{this, view});
            return;
        }
        currentPage--;
        if (currentPage == -1) {
            currentPage = this.imageArray.size() - 1;
        }
        Log.e("back", Integer.toString(currentPage));
        pager.setCurrentItem(currentPage, true);
    }
}
