...
public class Start extends Activity {
    ...
    public static final long serialVersionUID = 5912629506872990726L;

    /* renamed from: com.example.restro.Start$1 */
    public class C00081 implements OnItemClickListener {
        public static volatile transient /* synthetic */ IncrementalChange $change = null;
        public static final long serialVersionUID = 6118150633312368518L;
        public final /* synthetic */ Start this$0;

        C00081(Object[] objArr, InstantReloadException instantReloadException) {
            String str = objArr[1];
            int hashCode = str.hashCode();
            if (hashCode == -1968665286) {
                return;
            }
            if (hashCode == 1981253155) {
                this(objArr[2]);
            } else {
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/restro/Start$1"}));
            }
        }

        public static /* synthetic */ Object access$super(C00081 r3, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
        ...
        public C00081(Start this$02) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$02;
            if (incrementalChange != null) {
                Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/restro/Start$1;Lcom/example/restro/Start;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$02, new Object[0]});
                Object[] objArr2 = (Object[]) objArr[0];
                this(objArr, null);
                objArr2[0] = this;
                incrementalChange.access$dispatch("init$body.(Lcom/example/restro/Start$1;Lcom/example/restro/Start;[Ljava/lang/Object;)V", objArr2);
            }
        }
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            IncrementalChange incrementalChange = $change;
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("onItemClick.(Landroid/widget/AdapterView;Landroid/view/View;IJ)V", new Object[]{this, parent, view, new Integer(position), new Long(id)});
                return;
            }
            String s = (String) parent.getItemAtPosition(position);
            String str = "name";
            if (s.equals("Punjabi")) {
                Intent i = new Intent(this.this$0, Dishes.class);
                i.putExtra(str, s);
                this.this$0.startActivity(i);
            } else if (s.equals("Kathiyavadi")) {
                Intent i2 = new Intent(this.this$0, Dishes.class);
                i2.putExtra(str, s);
                this.this$0.startActivity(i2);
            } else if (s.equals("Chinese")) {
                Intent i3 = new Intent(this.this$0, Dishes.class);
                i3.putExtra(str, s);
                this.this$0.startActivity(i3);
            } else if (s.equals("South Indian")) {
                Intent i4 = new Intent(this.this$0, Dishes.class);
                i4.putExtra(str, s);
                this.this$0.startActivity(i4);
            }
        }
    }

    Start(Object[] objArr, InstantReloadException instantReloadException) {
        String str = objArr[1];
        int hashCode = str.hashCode();
        if (hashCode == -1230767868) {
            return;
        }
        if (hashCode == 1228252958) {
            this();
        } else {
            throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/restro/Start"}));
        }
    }

    public static /* synthetic */ Object access$super(Start start, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2147180915:
    ...
    public Start() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/restro/Start;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, new Object[0]});
            Object[] objArr2 = (Object[]) objArr[0];
            this(objArr, null);
            objArr2[0] = this;
            incrementalChange.access$dispatch("init$body.(Lcom/example/restro/Start;[Ljava/lang/Object;)V", objArr2);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0005R.layout.activity_list);
        ((TextView) findViewById(C0005R.C0006id.f0AC)).setText("Menu");
        DBHelper dbhelper = new DBHelper(getApplicationContext());
        dbhelper.openDataBase();
        List<String> array = dbhelper.Get_ContactDetails("SELECT * FROM Table1");
        dbhelper.close();
        ListView lv = (ListView) findViewById(C0005R.C0006id.f1lv);
        lv.setAdapter(new ArrayAdapter<>(this, C0005R.layout.activity_textview, C0005R.C0006id.f3tv, array));
        lv.setOnItemClickListener(new C00081(this));
    }
}
