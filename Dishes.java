...
public class Dishes extends Activity {
    ...
    public static final long serialVersionUID = -8651645723404274550L;
    public String type;

    /* renamed from: com.example.restro.Dishes$1 */
    public class C00031 implements OnItemClickListener {
        public static volatile transient /* synthetic */ IncrementalChange $change = null;
        public static final long serialVersionUID = 8710544804382997145L;
        public final /* synthetic */ Dishes this$0;

        C00031(Object[] objArr, InstantReloadException instantReloadException) {
            String str = objArr[1];
            int hashCode = str.hashCode();
            if (hashCode == -1968665286) {
                return;
            }
            if (hashCode == -832729209) {
                this(objArr[2]);
            } else {
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/restro/Dishes$1"}));
            }
        }

        public static /* synthetic */ Object access$super(C00031 r3, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
        ...
        public C00031(Dishes this$02) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$02;
            if (incrementalChange != null) {
                Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/restro/Dishes$1;Lcom/example/restro/Dishes;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$02, new Object[0]});
                Object[] objArr2 = (Object[]) objArr[0];
                this(objArr, null);
                objArr2[0] = this;
                incrementalChange.access$dispatch("init$body.(Lcom/example/restro/Dishes$1;Lcom/example/restro/Dishes;[Ljava/lang/Object;)V", objArr2);
            }
        }
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent i = new Intent(this.this$0, Slider.class);
            i.putExtra("Name", name);
            StringBuilder sb = new StringBuilder();
            sb.append("AND Type='");
            sb.append(this.this$0.type);
            sb.append("'");
            i.putExtra("type", sb.toString());
            this.this$0.startActivity(i);
        }
    }

    Dishes(Object[] objArr, InstantReloadException instantReloadException) {
        String str = objArr[1];
        int hashCode = str.hashCode();
        if (hashCode == -1230767868) {
            return;
        }
        if (hashCode == 1431176122) {
            this();
        } else {
            throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/restro/Dishes"}));
        }
    }

    public static /* synthetic */ Object access$super(Dishes dishes, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2147180915:
    ...
    public Dishes() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/restro/Dishes;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, new Object[0]});
            Object[] objArr2 = (Object[]) objArr[0];
            this(objArr, null);
            objArr2[0] = this;
            incrementalChange.access$dispatch("init$body.(Lcom/example/restro/Dishes;[Ljava/lang/Object;)V", objArr2);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView AC = (TextView) findViewById(C0005R.C0006id.f0AC);
        this.type = getIntent().getStringExtra("name");
        AC.setText(this.type);
        DBHelper dbhelper = new DBHelper(getApplicationContext());
        dbhelper.openDataBase();
        StringBuilder sb = new StringBuilder();
        sb.append("SELECT * FROM Table2 where Type='");
        sb.append(this.type);
        sb.append("'");
        List<String> array = dbhelper.Get_ContactDetails(sb.toString());
        dbhelper.close();
        ...
        lv.setOnItemClickListener(new C00031(this));
    }
}
